...
-- --------------------------------------------------------
CREATE
MATERIALIZED VIEW IF NOT EXISTS victor.mv_experiment_metrics
...
(
    ...
    first_conversion_at DateTime64
(
    3
),
...
-- --------------------------------------------------------
CREATE
MATERIALIZED VIEW IF NOT EXISTS victor.mv_conversion_metrics
TO victor.experiment_metrics
AS
SELECT toStartOfMinute(timestamp)                                     AS minute_bucket,
       exp_id,
